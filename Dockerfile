...
RUN git clone https://github.com/biomlds/Bringing-Old-Photos-Back-to-Life.git
...
RUN cd Bringing-Old-Photos-Back-to-Life/Face_Enhancement/ &&\
    wget https://github.com/biomlds/Bringing-Old-Photos-Back-to-Life/releases/download/v1.0/face_checkpoints.zip &&\
    unzip face_checkpoints.zip &&\
    cd ../ &&\
    cd Global/ &&\
    wget https://github.com/biomlds/Bringing-Old-Photos-Back-to-Life/releases/download/v1.0/global_checkpoints.zip &&\
